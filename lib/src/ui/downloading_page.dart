...
import 'package:flutter_localization_generator/src/widget/loading_animation.dart';
            ...
            children: snapshot.connectionState != ConnectionState.done ? [
              ...
              Padding(
                ...
                child: Text(
                  ...
                  style: TextStyle(color: defaultColorEditor, fontWeight: FontWeight.normal, fontFamily: 'monospace', fontSize: 25),
                ),
              )
            ] : [
